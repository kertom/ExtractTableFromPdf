...
/***/ "./node_modules/@ionic/core/dist/esm/es2017/build/mrs0ks1r.sc.entry.js":
/*!*****************************************************************************!*\
  !*** ./node_modules/@ionic/core/dist/esm/es2017/build/mrs0ks1r.sc.entry.js ***!
  \*****************************************************************************/
...
/* harmony import */ var _chunk_8b4dfddb_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-8b4dfddb.js */ "./node_modules/@ionic/core/dist/esm/es2017/build/chunk-8b4dfddb.js");
...
class Loading {
    ...
    onBackdropTap() {
        this.dismiss(undefined, _chunk_d97dc981_js__WEBPACK_IMPORTED_MODULE_1__["a"]);
    }
    async present() {
        await Object(_chunk_d97dc981_js__WEBPACK_IMPORTED_MODULE_1__["c"])(this, 'loadingEnter', iosEnterAnimation, mdEnterAnimation, undefined);
        if (this.duration > 0) {
    ...
    dismiss(data, role) {
        ...
        return Object(_chunk_d97dc981_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, data, role, 'loadingLeave', iosLeaveAnimation, mdLeaveAnimation);
    }
    onDidDismiss() {
        return Object(_chunk_d97dc981_js__WEBPACK_IMPORTED_MODULE_1__["e"])(this.el, 'ionLoadingDidDismiss');
    }
    onWillDismiss() {
        return Object(_chunk_d97dc981_js__WEBPACK_IMPORTED_MODULE_1__["e"])(this.el, 'ionLoadingWillDismiss');
    }
    hostData() {
        return {
            style: {
    ...
    render() {
        return [
            ...
            Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "loading-wrapper", role: "dialog" },
                ...
                this.message && Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "loading-content", innerHTML: Object(_chunk_8b4dfddb_js__WEBPACK_IMPORTED_MODULE_3__["a"])(this.message) }))
        ];
    }
...
class LoadingController {
    create(options) {
        return Object(_chunk_d97dc981_js__WEBPACK_IMPORTED_MODULE_1__["f"])(this.doc.createElement('ion-loading'), options);
    }
    dismiss(data, role, id) {
        return Object(_chunk_d97dc981_js__WEBPACK_IMPORTED_MODULE_1__["g"])(this.doc, data, role, 'ion-loading', id);
    }
    async getTop() {
        return Object(_chunk_d97dc981_js__WEBPACK_IMPORTED_MODULE_1__["h"])(this.doc, 'ion-loading');
    }
