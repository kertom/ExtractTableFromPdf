(function (p) { "object" == typeof exports && "object" == typeof module ? p(require("../../lib/codemirror")) : "function" == typeof define && define.amd ? define(["../../lib/codemirror"], p) : p(CodeMirror); })(function (p) {
    p.defineMode("javascript", function (oa, t) {
        function q(a, c, e) { E = a; I = e; return c; }
        function w(a, c) {
            var e = a.next();
            if ('"' == e || "'" == e)
        ...
        function pa(a) {
            return function (c, e) { var d = !1, b; if (L && "@" == c.peek() && c.match(qa))
                return e.tokenize = w, q("jsonld-keyword", "meta"); for (; null != (b = c.next()) && (b != a || d);)
                d = !d && "\\" == b; d || (e.tokenize = w); return q("string", "string"); };
        }
        function J(a, c) { for (var e = !1, d; d = a.next();) {
            if ("/" == d && e) {
                c.tokenize = w;
                break;
            }
        ...
        function Q(a, c) { for (var e = !1, d; null != (d = a.next());) {
            if (!e && ("`" == d || "$" == d && a.eat("{"))) {
                c.tokenize = w;
                break;
            }
        ...
        function ca(a, c, b, d, f, h) { this.indented = a; this.column = c; this.type = b; this.prev = f; this.info = h; null != d && (this.align = d); }
        function g() { for (var a = arguments.length - 1; 0 <= a; a--)
            f.cc.push(arguments[a]); }
        function b() { g.apply(null, arguments); return !0; }
        function x(a) { function c(c) { for (; c; c = c.next)
            if (c.name == a)
                return !0; return !1; } var b = f.state; b.context ? (f.marked = "def", c(b.localVars) || (b.localVars = { name: a, next: b.localVars })) : !c(b.globalVars) && t.globalVars && (b.globalVars = { name: a, next: b.globalVars }); }
        function y() { f.state.context = { prev: f.state.context, vars: f.state.localVars }; f.state.localVars = ra; }
        function z() { f.state.localVars = f.state.context.vars; f.state.context = f.state.context.prev; }
        function l(a, c) {
            var b = function () {
                var b = f.state, e = b.indented;
        ...
        function k() { var a = f.state; a.lexical.prev && (")" == a.lexical.type && (a.indented = a.lexical.indented), a.lexical = a.lexical.prev); }
        function m(a) { function c(e) { return e == a ? b() : ";" == a ? g() : b(c); } return c; }
        function r(a, c) {
        ...
        function W(a, c, e) { var d = 0 == e ? M : W, f = 0 == e ? n : u; if ("\x3d\x3e" == a)
            return b(y, e ? ga : ha, z); if ("operator" == a)
            return /\+\+|--/.test(c) ? b(d) : "?" == c ? b(n, m(":"), f) : b(f); if ("quasi" == a)
            return g(O, d); if (";" != a) {
            if ("(" == a)
                return G(u, ")", "call", d);
            if ("." == a)
        ...
        function ha(a) { S(f.stream, f.state); return g("{" == a ? r : n); }
        function ga(a) { S(f.stream, f.state); return g("{" == a ? r : u); }
        function sa(a) { return ":" == a ? b(k, r) : g(M, m(";"), k); }
        function Aa(a) { if ("variable" == a)
        ...
        function Ca(a) { if ("variable" != a)
            return g(H); f.marked = "property"; return b(v); }
        function H(a) { if (":" == a)
            return b(u); if ("(" == a)
            return g(v); }
        function F(a, c) { function e(d) { return "," == d ? (d = f.state.lexical, "call" == d.info && (d.pos = (d.pos || 0) + 1), b(a, e)) : d == c ? b() : b(m(c)); } return function (d) { return d == c ? b() : g(a, e); }; }
        function G(a, c, e) { for (var d = 3; d < arguments.length; d++)
            f.cc.push(arguments[d]); return b(l(c, e), F(a, c), k); }
        function U(a) {
            return "}" == a ?
                b() : g(r, U);
        }
        function ja(a) { if (ka && ":" == a)
            return b(Da); }
        function Da(a) { if ("variable" == a)
            return f.marked = "variable-3", b(); }
        function T() { return g(A, ja, Y, Ea); }
        function A(a, c) { if ("variable" == a)
            return x(c), b(); if ("[" == a)
            return G(A, "]"); if ("{" == a)
            return G(Fa, "}"); }
        function Fa(a, c) { if ("variable" == a && !f.stream.match(/^\s*:/, !1))
            return x(c), b(Y); "variable" == a && (f.marked = "property"); return b(m(":"), A, Y); }
        function Y(a, c) { if ("\x3d" == c)
            return b(u); }
        function Ea(a) { if ("," == a)
            return b(T); }
        function da(a, c) {
        ...
        function v(a, c) {
            ...
            if ("variable" == a)
                return x(c), b(v);
            if ("(" == a)
                return b(y, l(")"), F(V, ")"), k, r, z);
        }
        function V(a) { return "spread" == a ? b(V) : g(A, ja); }
        function ua(a, c) { if ("variable" == a)
            return x(c), b(ma); }
        function ma(a, c) { if ("extends" == c)
            return b(n, ma); if ("{" == a)
            return b(l("}"), B, k); }
        function B(a, c) { if ("variable" == a || "keyword" == f.style) {
            if ("static" == c)
                return f.marked = "keyword", b(B);
            f.marked = "property";
            return "get" == c || "set" == c ? b(Ia, v, B) : b(v, B);
        } if ("*" == c)
            return f.marked = "keyword", b(B); if (";" == a)
            return b(B); if ("}" == a)
            return b(); }
        function Ia(a) {
            if ("variable" != a)
        ...
        function ta(a, c) { if ("string" == a)
            return b(r); if ("variable" == a)
            return x(c), b(Z); }
        ...
        function aa(a, c) { if ("{" == a)
            return G(aa, "}"); "variable" == a && x(c); "*" == c && (f.marked = "keyword"); return b(Ja); }
        function Ja(a, c) { if ("as" == c)
            return f.marked = "keyword", b(aa); }
        function Z(a, c) { if ("from" == c)
        ...
        function N(a) { if ("for" == a)
            return b(ea, N); if ("if" == a)
            return b(n, N); }
        var C = oa.indentUnit, na = t.statementIndent, L = t.jsonld, D = t.json || L, ka = t.typescript, R = t.wordCharacters || /[\w$\xa1-\uffff]/, ba = function () {
            ...
            if (ka) {
                var b = { type: "variable", style: "variable-3" }, b = { "interface": a("interface"), "extends": a("extends"), constructor: a("constructor"), "public": a("public"), "private": a("private"), "protected": a("protected"), "static": a("static"), string: b, number: b, bool: b, any: b }, g;
                for (g in b)
                    c[g] = b[g];
            }
            return c;
            ...
            next: { name: "arguments" } };
        k.lex = !0;
        return { startState: function (a) { a = { tokenize: w, lastType: "sof", cc: [], lexical: new ca((a || 0) - C, 0, "block", !1), localVars: t.localVars, context: t.localVars && { vars: t.localVars }, indented: 0 }; t.globalVars && "object" == typeof t.globalVars && (a.globalVars = t.globalVars); return a; }, token: function (a, b) {
