...
*/
(function () {
    function d(c) { var d = this instanceof CKEDITOR.ui.dialog.checkbox; c.hasAttribute(this.id) && (c = c.getAttribute(this.id), d ? this.setValue(f[this.id]["true"] == c.toLowerCase()) : this.setValue(c)); }
    function e(c) { var d = "" === this.getValue(), a = this instanceof CKEDITOR.ui.dialog.checkbox, e = this.getValue(); d ? c.removeAttribute(this.att || this.id) : a ? c.setAttribute(this.id, f[this.id][e]) : c.setAttribute(this.att || this.id, e); }
    ...
    CKEDITOR.dialog.add("iframe", function (c) {
        ...
        return { title: g.title, minWidth: 350, minHeight: 260, getModel: function (b) { return (b = b.getSelection().getSelectedElement()) && "iframe" === b.data("cke-real-element-type") ? b : null; }, onShow: function () { this.fakeImage = this.iframeNode = null; var b = this.getSelectedElement(); b && b.data("cke-real-element-type") && "iframe" == b.data("cke-real-element-type") && (this.fakeImage = b, this.iframeNode = b = c.restoreRealElement(b), this.setupContent(b)); },
            onOk: function () { var b; b = this.fakeImage ? this.iframeNode : new CKEDITOR.dom.element("iframe"); var a = {}, d = {}; this.commitContent(b, a, d); b = c.createFakeElement(b, "cke_iframe", "iframe", !0); b.setAttributes(d); b.setStyles(a); this.fakeImage ? (b.replace(this.fakeImage), c.getSelection().selectElement(b)) : c.insertElement(b); }, contents: [{ id: "info", label: a.generalTab, accessKey: "I", elements: [{ type: "vbox", padding: 0, children: [{ id: "src", type: "text", label: a.url, required: !0, validate: CKEDITOR.dialog.validate.notEmpty(g.noUrl),
                                    ...
                                    requiredContent: "iframe[align]", "default": "", items: [[a.notSet, ""], [a.left, "left"], [a.right, "right"], [a.alignTop, "top"], [a.alignMiddle, "middle"], [a.alignBottom, "bottom"]], style: "width:100%", labelLayout: "vertical", label: a.align, setup: function (b, a) { d.apply(this, arguments); if (a) {
                                        var c = a.getAttribute("align");
                                        this.setValue(c && c.toLowerCase() || "");
                                    } }, commit: function (a, c, d) { e.apply(this, arguments); this.getValue() && (d.align = this.getValue()); } }] }, { type: "hbox", widths: ["50%", "50%"], children: [{ id: "scrolling", type: "checkbox",
