...
/***/ "./node_modules/@ionic/core/dist/esm/es2017/build/pd9wflli.sc.entry.js":
/*!*****************************************************************************!*\
  !*** ./node_modules/@ionic/core/dist/esm/es2017/build/pd9wflli.sc.entry.js ***!
  \*****************************************************************************/
...
/* harmony import */ var _chunk_19910bac_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chunk-19910bac.js */ "./node_modules/@ionic/core/dist/esm/es2017/build/chunk-19910bac.js");
...
class Nav {
    ...
    async componentDidLoad() {
        this.rootChanged();
        this.gesture = (await Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e("common"), __webpack_require__.e(2)]).then(__webpack_require__.bind(null, /*! ./chunk-267dafff.js */ "./node_modules/@ionic/core/dist/esm/es2017/build/chunk-267dafff.js"))).createSwipeBackGesture(this.el, this.queue, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
        this.swipeGestureChanged();
    }
    componentDidUnload() {
        for (const view of this.views) {
            Object(_chunk_19910bac_js__WEBPACK_IMPORTED_MODULE_4__["b"])(view.element, _chunk_90d954cd_js__WEBPACK_IMPORTED_MODULE_3__["e"]);
            view._destroy();
        }
        if (this.gesture) {
    ...
    postViewInit(enteringView, leavingView, ti) {
        ...
        if (destroyQueue && destroyQueue.length > 0) {
            for (const view of destroyQueue) {
                Object(_chunk_19910bac_js__WEBPACK_IMPORTED_MODULE_4__["b"])(view.element, _chunk_90d954cd_js__WEBPACK_IMPORTED_MODULE_3__["a"]);
                Object(_chunk_19910bac_js__WEBPACK_IMPORTED_MODULE_4__["b"])(view.element, _chunk_90d954cd_js__WEBPACK_IMPORTED_MODULE_3__["d"]);
                Object(_chunk_19910bac_js__WEBPACK_IMPORTED_MODULE_4__["b"])(view.element, _chunk_90d954cd_js__WEBPACK_IMPORTED_MODULE_3__["e"]);
            }
            for (const view of destroyQueue) {
    ...
    async transition(enteringView, leavingView, ti) {
        ...
        const animationOpts = Object.assign({ mode: this.mode, showGoBack: this.canGoBackSync(enteringView), queue: this.queue, window: this.win, baseEl: this.el, animationBuilder: this.animation || opts.animationBuilder || this.config.get('navAnimation'), progressCallback, animated: this.animated && this.config.getBoolean('animated', true), enteringEl,
            leavingEl }, opts);
        const { hasCompleted } = await Object(_chunk_19910bac_js__WEBPACK_IMPORTED_MODULE_4__["c"])(animationOpts);
    ...
    cleanup(activeView) {
        ...
        for (let i = views.length - 1; i >= 0; i--) {
            ...
            if (i > activeViewIndex) {
                Object(_chunk_19910bac_js__WEBPACK_IMPORTED_MODULE_4__["b"])(element, _chunk_90d954cd_js__WEBPACK_IMPORTED_MODULE_3__["e"]);
                this.destroyView(view);
            }
            else if (i < activeViewIndex) {
                Object(_chunk_19910bac_js__WEBPACK_IMPORTED_MODULE_4__["d"])(element, true);
            }
        }
    }
    canStart() {
