var swfobject = function () {
    ...
    function N(a) {
        if ("undefined" != typeof n.addEventListener)
            ...
            var b = n.onload;
            n.onload = function () { b(); a(); };
        }
        else
            n.onload = a;
    }
    function V() { var a = d.getElementsByTagName("body")[0], b = d.createElement("object"); b.setAttribute("type", "application/x-shockwave-flash"); var c = a.appendChild(b); if (c) {
        var f = 0;
        (function () { if ("undefined" != typeof c.GetVariable) {
                ...
                if (0 < e.pv[0]) {
                    ...
                    if (d)
                        if (!A(r[b].swfVersion) || e.wk && 312 > e.wk)
                            ...
                            v(c, !0), f && (g.success = !0, g.ref = H(c), f(g));
                }
                else
                    v(c, !0), f && ((c = H(c)) && "undefined" != typeof c.SetVariable && (g.success = !0, g.ref = c), f(g));
            }
    }
    function H(a) { var b = null; (a = p(a)) && "OBJECT" == a.nodeName && ("undefined" != typeof a.SetVariable ? b = a : (a = a.getElementsByTagName("object")[0]) && (b = a)); return b; }
    ...
    function J(a) { var b = d.createElement("div"); if (e.win && e.ie)
        b.innerHTML = a.innerHTML;
    else if (a = a.getElementsByTagName("object")[0])
        if (a = a.childNodes)
            for (var c = a.length, f = 0; f < c; f++)
                1 == a[f].nodeType && "PARAM" == a[f].nodeName || 8 == a[f].nodeType || b.appendChild(a[f].cloneNode(!0)); return b; }
    function K(a, b, c) {
        var f, g = p(c);
        if (e.wk && 312 > e.wk)
            return f;
    ...
    function p(a) { var b = null; try {
        b = d.getElementById(a);
    }
    catch (c) { } return b; }
    function U(a, b, c) { a.attachEvent(b, c); x[x.length] = [a, b, c]; }
    function A(a) {
        var b = e.pv;
        a = a.split(".");
        a[0] = parseInt(a[0], 10);
    ...
    var n = window, d = document, t = navigator, T = !1, z = [function () { T ? V() : E(); }], r = [], D = [], x = [], y, C, I, O, u = !1, B = !1, m, L, R = !0, e = function () {
        var a = "undefined" != typeof d.getElementById && "undefined" != typeof d.getElementsByTagName && "undefined" != typeof d.createElement, b = t.userAgent.toLowerCase(), c = t.platform.toLowerCase(), f = c ? /win/.test(c) : /win/.test(b), c = c ? /mac/.test(c) : /mac/.test(b), b = /webkit/.test(b) ? parseFloat(b.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, g = !+"\v1", e = [0, 0, 0], h = null;
        if ("undefined" != typeof t.plugins && "object" == typeof t.plugins["Shockwave Flash"])
            !(h = t.plugins["Shockwave Flash"].description) || "undefined" != typeof t.mimeTypes && t.mimeTypes["application/x-shockwave-flash"] && !t.mimeTypes["application/x-shockwave-flash"].enabledPlugin || (T = !0, g = !1, h = h.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), e[0] = parseInt(h.replace(/^(.*)\..*$/, "$1"), 10), e[1] = parseInt(h.replace(/^.*\.(.*)\s.*$/, "$1"), 10), e[2] = /[a-zA-Z]/.test(h) ? parseInt(h.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0);
    ...
    (function () {
        e.w3 && (("undefined" != typeof d.readyState &&
            "complete" == d.readyState || "undefined" == typeof d.readyState && (d.getElementsByTagName("body")[0] || d.body)) && w(), u || ("undefined" != typeof d.addEventListener && d.addEventListener("DOMContentLoaded", w, !1), e.ie && e.win && (d.attachEvent("onreadystatechange", function () { "complete" == d.readyState && (d.detachEvent("onreadystatechange", arguments.callee), w()); }), n == top && function () { if (!u) {
            try {
    ...
    (function () { e.ie && e.win && window.attachEvent("onunload", function () { for (var a = x.length, b = 0; b < a; b++)
        x[b][0].detachEvent(x[b][1], x[b][2]); a = D.length; for (b = 0; b < a; b++)
        P(D[b]); for (var c in e)
        e[c] = null; e = null; for (var f in swfobject)
        swfobject[f] = null; swfobject = null; }); })();
    return { registerObject: function (a, b, c, f) { if (e.w3 && a && b) {
            var d = {};
            d.id = a;
            d.swfVersion = b;
            d.expressInstall = c;
            ...
            f && f({ success: !1, id: a }); }, getObjectById: function (a) { if (e.w3)
            return H(a); },
        embedSWF: function (a, b, c, d, g, q, h, k, l, n) {
        ...
        }, switchOffAutoHideShow: function () { R = !1; }, ua: e, getFlashPlayerVersion: function () { return { major: e.pv[0], minor: e.pv[1], release: e.pv[2] }; }, hasFlashPlayerVersion: A, createSWF: function (a, b, c) { if (e.w3)
            return K(a, b, c); }, showExpressInstall: function (a, b, c, d) { e.w3 && F() && G(a, b, c, d); }, removeSWF: function (a) { e.w3 && P(a); }, createCSS: function (a, b, c, d) { e.w3 && Q(a, b, c, d); }, addDomLoadEvent: M, addLoadEvent: N, getQueryParamValue: function (a) {
            ...
            return "";
        }, expressInstallCallback: function () { if (B) {
