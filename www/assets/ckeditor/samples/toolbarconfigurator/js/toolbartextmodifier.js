(function () {
    function e(a) { l.call(this, a); this.hintContainer = this.codeContainer = null; }
    ...
    e.prototype._onInit = function (a, d) { l.prototype._onInit.call(this, void 0, d); this._createModifier(d ? this.actualConfig : void 0); "function" === typeof a && a(this.mainContainer); };
    e.prototype._createModifier = function (a) {
        function d(a) {
            var b = c(a);
            if (null !== b.charsBetween) {
                var d = k.getUnusedButtonsArray(k.actualConfig.toolbar, !0, b.charsBetween), e = a.getCursor(), b = CodeMirror.Pos(e.line, e.ch - b.charsBetween.length), h = a.getTokenAt(e);
                "{" === a.getTokenAt({ line: e.line, ch: h.start }).string && (d = ["name"]);
                if (0 !== d.length)
                    return new f(b, e, d);
            }
        }
        function f(a, c, b) { this.from = a; this.to = c; this.list = b; this._handlers = []; }
        function c(a, c) {
            var b = {};
            b.cur = a.getCursor();
            b.tok = a.getTokenAt(b.cur);
            b["char"] = c || b.tok.string.charAt(b.tok.string.length - 1);
            var d = a.getRange(CodeMirror.Pos(b.cur.line, 0), b.cur).split("").reverse().join(""), d = d.replace(/(['|"]\w*['|"])/g, "");
            b.charsBetween = d.match(/(^\w*)(['|"])/);
            b.charsBetween && (b.endChar = b.charsBetween[2], b.charsBetween = b.charsBetween[1].split("").reverse().join(""));
            return b;
        }
        function b(a) { setTimeout(function () { a.state.completionActive || CodeMirror.showHint(a, d, { hintsClass: "toolbar-modifier", completeSingle: !1 }); }, 100); return CodeMirror.Pass; }
        var k = this;
        this._createToolbar();
        ...
        this.codeContainer = CodeMirror(e.$, { mode: { name: "javascript",
                json: !0 }, lineNumbers: !1, lineWrapping: !0, viewportMargin: Infinity, value: a, smartIndent: !1, indentWithTabs: !0, indentUnit: 4, tabSize: 4, theme: "neo", extraKeys: { Left: b, Right: b, "'''": b, "'\"'": b, Backspace: b, Delete: b, "Shift-Tab": "indentLess" } });
        this.codeContainer.on("endCompletion", function (a, b) { var d = c(a); void 0 !== b && a.replaceSelection(d.endChar); });
    ...
    e.prototype._mapToolbarSubgroup = function (a, d) { if ("string" == typeof a)
        return a; for (var f = a.groups ? a.groups.length : 0, c = [], b = 0; b < f; b += 1) {
    ...
    e.prototype._mapButtonsToButtonsNames = function (a, d) { for (var f = a.length; f--;) {
    ...
    e.prototype._evaluateValue = function (a) { var d; try {
        var f = {};
    ...
    e.prototype.mapToolbarToToolbarGroups = function (a) {
        ...
        c = function (a, b) {
            var c = [], e;
            for (e in a)
                var f = a[e], g = b[e].slice(), c = c.concat(d(g, Object.keys(f.buttons)));
            return c;
